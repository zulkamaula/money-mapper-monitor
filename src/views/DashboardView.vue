      ...
      <VContainer fluid class="dashboard-container px-6">
        ...
        <div v-if="selectedBook">
          <VRow>
            ...
            <!-- Right Column: Allocations History -->
            <VCol cols="12" md="8">
        ...
        <!-- Empty State -->
        <div v-else-if="!loading && moneyBooks.length === 0" class="empty-dashboard text-center py-16">
          <VIcon icon="mdi-book-open-variant" size="80" color="grey-lighten-1" class="mb-4" />
          <div class="text-h6 text-grey-darken-1 mb-2">No Money Books Yet</div>
          <div class="text-grey">Click the button above to create your first money book</div>
        </div>
      </VContainer>
    </VMain>
